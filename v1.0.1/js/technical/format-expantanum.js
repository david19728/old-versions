...
function formatTime(s) {
    if (s.lt(60)) return format(s) + "秒"
    else if (s.lt(3600)) return formatWhole(s.div(60).floor()) + "分" + format() + "秒"
    else if (s.lt(86400)) return formatWhole(s.div(3600).floor()) + "时" + formatWhole(s.div(60).floor().mod(60)) + "分" + format(s.mod(60)) + "秒"
    else if (s.lt(31536000)) return formatWhole(s.div(86400).floor().mod(365)) + "天" + formatWhole(s.div(3600).floor().mod(24)) + "时" + formatWhole(s.div(60).floor().mod(60)) + "分" + format(s.mod(60)) + "秒"
    else return formatWhole(s.div(31536000).floor()) + "年" + formatWhole(s.div(86400).floor().mod(365)) + "天" + formatWhole(s.div(3600).floor().mod(24)) + "时" + formatWhole(s.div(60).floor().mod(60)) + "分" + format(s.mod(60)) + "秒"
}