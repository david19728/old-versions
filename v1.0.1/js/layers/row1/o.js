addLayer("o", {
    ...
    update(diff)
    {
        ...
        if(hasUpgrade("p",11))
        {
            player.o.mult2 = player.o.mult2.mul(getBuyableAmount("o",18).add(1).pow(3))
            player.o.mult3 = player.o.mult3.mul(getBuyableAmount("o",18).add(1).pow(3))
            player.o.mult4 = player.o.mult4.mul(getBuyableAmount("o",18).add(1).pow(3))
            player.o.mult5 = player.o.mult5.mul(getBuyableAmount("o",18).add(1).pow(3))
            player.o.mult6 = player.o.mult6.mul(getBuyableAmount("o",18).add(1).pow(3))
            player.o.mult7 = player.o.mult7.mul(getBuyableAmount("o",18).add(1).pow(3))
        }
        if(hasUpgrade("p",12))
        {
            player.o.driverBase = ExpantaNum(3.5)
        }
        ...
        if(hasUpgrade("b",12))
        {
            player.o.sacExp = ExpantaNum(0.1)
        }
        if(player.au.d1auto && player.au.points.gte(1))
        {
            if(player.au.d1max)
            {
                buyMaxBuyable("o",11)
        ...
        if(player.au.d2auto && player.au.points.gte(2))
        {
            if(player.au.d2max)
            {
                buyMaxBuyable("o",12)
        ...
        if(player.au.d3auto && player.au.points.gte(3))
        {
            if(player.au.d3max)
            {
                buyMaxBuyable("o",13)
        ...
        if(player.au.d4auto && player.au.points.gte(4))
        {
            if(player.au.d4max)
            {
                buyMaxBuyable("o",14)
        ...
        if(player.au.d5auto && player.au.points.gte(5))
        {
            if(player.au.d5max)
            {
                buyMaxBuyable("o",15)
        ...
        if(player.au.d6auto && player.au.points.gte(6))
        {
            if(player.au.d6max)
            {
                buyMaxBuyable("o",16)
        ...
        if(player.au.d7auto && player.au.points.gte(7))
        {
            if(player.au.d7max)
            {
                buyMaxBuyable("o",17)
        ...
        if(player.au.d8auto && player.au.points.gte(8))
        {
            if(player.au.d8max)
            {
                buyMaxBuyable("o",18)
        ...
        if(player.au.driverAuto && player.au.points.gte(10))
        {
    ...
    buyables: {
        ...
        22: {
            ...
            display() {
                ...
                display22 += "×<br>↓<br>"
                display22 += player.points.pow(player.o.sacExp)
                display22 += "×</h3>"
                return display22
            },
            ...
            buy() {
                ...
                player.o.sacMult = player.points.pow(player.o.sacExp)
