    ...
    buyables: {
        ...
        12: {
            ...
            effect(x) {
                ...
                setInterval(d2mult = d2mult.add(ExpantaNum(0.01).mul(mult2)),10);
            },
            display() {
                var display12 = "数量："
        ...
        13: {
            ...
            effect(x) {
                ...
                setInterval(d3mult = d3mult.add(ExpantaNum(0.01).mul(mult3)),10);
            },
            display() {
                var display13 = "数量："
        ...
        14: {
            ...
            effect(x) {
                ...
                setInterval(d4mult = d4mult.add(ExpantaNum(0.01).mul(mult4)),10);
            },
            display() {
                var display14 = "数量："
        ...
        15: {
            ...
            effect(x) {
                ...
                setInterval(d5mult = d5mult.add(ExpantaNum(0.01).mul(mult5)),10);
            },
            display() {
                var display15 = "数量："
        ...
        16: {
            ...
            effect(x) {
                ...
                setInterval(d6mult = d6mult.add(ExpantaNum(0.01).mul(mult6)),10);
            },
            display() {
                var display16 = "数量："
        ...
        17: {
            ...
            effect(x) {
                ...
                setInterval(d7mult = d7mult.add(ExpantaNum(0.01).mul(mult7)),10);
            },
            display() {
                var display17 = "数量："
        ...
        18: {
            ...
            effect(x) {
                ...
                setInterval(d8mult = d8mult.add(ExpantaNum(0.01).mul(mult8)),10);
            },
            display() {
                var display18 = "数量："
                display18 += getBuyableAmount("o",17)
                display18 += "<br>价格："
                display18 += this.cost()
                return display18
            },
